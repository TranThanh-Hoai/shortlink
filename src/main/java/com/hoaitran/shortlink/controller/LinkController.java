...
public class LinkController {
    ...
    public ResponseEntity<LinkResponse> shorten(@RequestBody ShortenRequest request, HttpServletRequest servletRequest) {
        var link = linkService.shortenUrl(request);
